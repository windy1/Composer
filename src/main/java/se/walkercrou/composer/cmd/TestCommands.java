...
import static se.walkercrou.composer.util.PitchUtils.A0;
import static se.walkercrou.composer.util.PitchUtils.A1;
import static se.walkercrou.composer.util.PitchUtils.B0;
import static se.walkercrou.composer.util.PitchUtils.B1;
import static se.walkercrou.composer.util.PitchUtils.D2;
import static se.walkercrou.composer.util.PitchUtils.G0;
import static se.walkercrou.composer.util.PitchUtils.G1;
...
public class TestCommands {
    ...
    private CommandResult readNbsFile(CommandSource src, CommandContext context) throws CommandException {
        ...
        } catch (IOException| CorruptedFileException | OldNbsVersionException e) {
            e.printStackTrace();
